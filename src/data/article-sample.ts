...
import { sampleBusinessListings } from './business-sample';
...
// Different from sidebar (which now shows businesses, not articles).
// ============================================================
...
export function getArticlePageData(): ArticlePageData {
  return {
    ...
    sidebarBusinesses: sampleBusinessListings,
    categoryDiscovery,
  };
}
